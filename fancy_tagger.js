...
var host = 'https://fancy.com/bookmarklet/fancy.com', prefix = 'fancy_';
...
if(location.search.indexOf("bigbird")>-1) host = 'https://fancy.com/bookmarklet/bigbird.fancy.com';
if(location.search.indexOf("pistos")>-1) host = 'https://fancy.com/bookmarklet/pistos.fancy.com';
...
(function(){
	...
	if(!wrapper.obj) {
		...
		css(wrapper.obj, {position:'absolute',display:'none', top:0, left:0, width:'100%', opacity:0, zIndex:9999999, webkitTransition:'https://fancy.com/bookmarklet/opacity .3s', mozTransiiton:'https://fancy.com/bookmarklet/opacity .3s', msTransition:'https://fancy.com/bookmarklet/opacity .3s'});
	}
