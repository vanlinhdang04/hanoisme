var whi = whi || {};
whi.website = "https://weheartit.com/";
...
whi.AlertHtml.prototype.alertData = {
    ...
    noHeart: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_no_heart') + "</div>",
    noPin: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_no_pin') + "</div>",
    weHeartIt: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_we_heart_it') + " <a href='https://weheartit.com/help/hearting-images-on-we-heart-it' target='_blank'><br><br>" + whi.i18n.t('bookmarklet.need_help_q') + "</div>",
    private: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_private') + " <a href='https://weheartit.com/help/hearting-from-private-pages' target='_blank'><br><br>" + whi.i18n.t('bookmarklet.need_help_q') + "</a></div>",
    googleImages: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_google_images') + "</span>",
    ...
    noImages: '<div class="whi-title">' + whi.i18n.t('https://weheartit.com/bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.no_image_we_can_heart') + " <a href='https://weheartit.com/help/invalid-images' target='_blank'>" + whi.i18n.t('bookmarklet.why_is_that_q') + "</a></div>",
...
whi.ImageElement.prototype.isValid = function () {
    ...
    conditions.push({ valid: !this.image.src.match("https://weheartit.com/weheartit.com"), msg: 'From weheartit' });
    conditions.push({ valid: !(this.image.src.match("https://weheartit.com/facebook.com") && this.image.src.match('messaging')), msg: 'Facebook chat' });
...
whi.TumblrImageElement.prototype.via = function () {
    ...
    } else if (this.document.location.host.match(/.+\.tumblr.com/) && this.document.location.host !== 'https://weheartit.com/www.tumblr.com') {
...
whi.bookmarklet = (function () {
    ...
    var module = {
        settings: {
            bookmarkletVersion: "https://weheartit.com/2.1.10",
            heartingMethod: "bookmarklet"
        },

        init: function (isRunningFromBookmarklet, preferences) {
            whi.website = whi.website || "https://weheartit.com/";
            ...
            return {
                image: {
                    all: function () {
                        ...
                        if (doc.location.host === "https://weheartit.com/www.tumblr.com" && doc.location.pathname === "/") {
                        ...
                        if (doc.location.host === "https://weheartit.com/instagram.com") {
        ...
        page: {
            ...
            validationActions: {
                image: function () { location.href = "https://weheartit.com/help/hearting-images-not-in-a-web-page" },
        ...
        grid: {
            ...
            _createTopBar: function () {
                ...
                bar.innerHTML = '<span class="whi-excl whi-left">Choose an image to heart</span><a href="https://weheartit.com/" class="logo"></a>';
                bar.className = "whi-topbar";

                var closeButton = document.createElement('a');
                closeButton.className = "whi-button-close whi-right";
                closeButton.href = "#";
