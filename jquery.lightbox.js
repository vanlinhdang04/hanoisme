...
//                    newWidth = initialPageWidth;
    ...
    jQuery.fn.lightbox.defaults = {
        fileLoadingImage: 'loading.gif'/*tpa=http://hanoisme.vn/cms/display/js/lightbox/css/loading.gif*/,
        fileBottomNavCloseImage: 'closelabel.gif'/*tpa=http://hanoisme.vn/cms/display/js/lightbox/css/closelabel.gif*/,
        overlayOpacity: 0.8,
        borderSize: 10,
